...
local Rayfield = useStudio and script.Parent:FindFirstChild('AstralCheat') or game:GetObjects("rbxassetid://10804731440")[1]
...
repeat
	...
	toDestroy, Rayfield = Rayfield, useStudio and script.Parent:FindFirstChild('SFXCL') or game:GetObjects("rbxassetid://10804731440")[1]
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.ShowText then
		MPrompt.Title.Text = 'by '..Settings.ShowText
	end

	LoadingFrame.Version.TextTransparency = 1
	LoadingFrame.Title.Text = Settings.LoadingTitle or "SFXCL"
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or "Interface Suite"

	if Settings.LoadingTitle ~= "Rayfield Interface Suite" then
		LoadingFrame.Version.Text = "Используйте на свой страх и риск!"
	end
		...
		function Tab:CreateInput(InputSettings)
			...
			Input.InputFrame.InputBox.FocusLost:Connect(function()
				...
				if not Success then
					...
					print("SFXCL | "..InputSettings.Name.." Callback Error " ..tostring(Response))
					warn('Check docs.sirius.menu for help with Rayfield specific development.')
					task.wait(0.5)
					Input.Title.Text = InputSettings.Name
