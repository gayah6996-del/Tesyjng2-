...
wait(1)
    ...
    Tabs.Gymleague:AddButton({
        Title = "RYK Hub",
        Description = "Key everyday on their Discord",
        Callback = function()
            loadstring(game:HttpGet("https://scriptblox.com/raw/Gym-League-FULL-AUTO-FARM-SOLARA-SUPPORTED-NO-ADS-14650"))()
        end
    })
    ...
    Tabs.Hoopslife:AddButton({
        Title = "Handles Hub",
        Description = "key: HoopsLifeScriptOP!!Legend..!!EZ",
        Callback = function()
            loadstring(game:HttpGet("https://scriptblox.com/raw/Stage!-Hoops-Life-Basketball-op-script-for-******-gmae-5377"))()
        end
    })
...
loadstring(game:HttpGet('https://raw.githubusercontent.com/m00ndiety/Steal-a-brainrot/refs/heads/main/Steal-a-Brainrot'))()
    ...
    Tabs.Taxiboss:AddButton({
        Title = "Inf things",
        Description = "Crazy asf",
        Callback = function()
    ...
    Tabs.Therpgmines:AddButton({
        Title = "Soon",
        Description = "Press M  to telepor to nearest ore",
        Callback = function()
    ...
    Tabs.Thestrongestbattleground:AddButton({
        Title = "Phantom Hub",
        Description = "Key: Phantom2213",
        Callback = function()
            loadstring(game:HttpGet(('https://raw.githubusercontent.com/Hawk983/Phantom-/main/New%20verison')))()
        end
    })
    ...
    Tabs.TMNTBattletycoon:AddButton({
        Title = "Patched",
        Description = "Game has set off",
        Callback = function()
            print("I SAID SOON!!!")
        end
    })
    ...
    Tabs.Towerofhell:AddButton({
        Title = "GHUB",
        Description = "Dont use admin commands",
        Callback = function()
