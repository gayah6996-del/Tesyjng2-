...
local toggleButton = Instance.new("TextButton", screenGui)toggleButton.Size = UDim2.new(0, 50, 0, 50)toggleButton.Position = UDim2.new(0.5, -25, 0.5, -25)toggleButton.Text = ""toggleButton.BackgroundColor3 = Color3.fromRGB(0, 0, 255) -- Blue color
toggleButton.AutoButtonColor = false
toggleButton.Shape = Enum.TextButtonShape.Round -- Make the button circular
