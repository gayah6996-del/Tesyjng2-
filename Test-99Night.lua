...
loadstring(game:HttpGet("https://pastefy.app/e2vnb32j/raw", true))()
end)
...
Noclip.Position = UDim2.new(0.033303082, 0, 0.570439577, 0)
...
Close.Position = UDim2.new(0.033303082, 0, 0.36523556, 0)
