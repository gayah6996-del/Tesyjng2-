...
local function createMainGUI()
    ...
    infiniteJumpButton.Position = UDim2.new(0.05, 0, 0.17, 0)
    ...
    cameraFOVButton.Position = UDim2.new(0.05, 0, 0.28, 0)
    ...
    cameraFOVSliderFrame.Position = UDim2.new(0.05, 0, 0.42, 0)
