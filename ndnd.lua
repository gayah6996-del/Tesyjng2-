...
local function createMainGUI()
    ...
    infiniteJumpButton.Position = UDim2.new(0.05, 0, 0.15, 20) -- Увеличено с 20 до 40
    ...
    cameraFOVButton.Position = UDim2.new(0.05, 0, 0.25, 60) -- Увеличено с 45 до 80
    ...
    cameraFOVSliderFrame.Position = UDim2.new(0.05, 0, 0.35, 100) -- Увеличено с 70 до 120
    ...
    speedHackSliderFrame.Position = UDim2.new(0.05, 0, 0.55, 140) -- Увеличено с 100 до 160
